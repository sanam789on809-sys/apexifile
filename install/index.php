<?php
/**
 * Contains the form and the processes used to install CGT.
 */
        ...
        <div class="white-box">
            <div class="white-box-interior">
                ...
                <form action="index.php" name="install_form" id="install_form" method="post" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        <label for="base_uri" class="col-sm-4 control-label"><?php _e('CGT URI (address)', 'cftp_admin'); ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <button type="button" name="generate_password" id="generate_password" class="btn btn-light btn-sm btn_generate_password" data-ref="admin_pass" data-min="<?php echo MAX_GENERATE_PASS_CHARS; ?>" data-max="<?php echo MAX_GENERATE_PASS_CHARS; ?>"><?php _e('Generate', 'cftp_admin'); ?></button>
                        </div>
                    </div>
