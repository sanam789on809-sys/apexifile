<?php
/*
Template name: PinBoxes - Public Files
...
if ($count == 0) {
    if (isset($_GET['search'])) {
        $no_results_message = __('Your search keywords returned no results.', 'pinboxes_template');
    } else {
        $no_results_message = __('There are no files available.', 'pinboxes_template');
    }
}
...
<html>
	...
	<body>
		...
		<div id="menu">
			<p class="welcome">
				<?php _e('Public file access','pinboxes_template'); ?>
			</p>
			<ul>
				<li id="search_box">
