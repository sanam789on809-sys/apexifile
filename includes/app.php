...
// Custom DMS tables
define('TABLE_DEPARTMENTS', TABLES_PREFIX . 'departments');
define('TABLE_DEPARTMENT_MEMBERS', TABLES_PREFIX . 'department_members');
define('TABLE_TASKS', TABLES_PREFIX . 'tasks');
define('TABLE_TICKETS', TABLES_PREFIX . 'tickets');
