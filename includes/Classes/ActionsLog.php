...
class ActionsLog
{
    ...
    public function getActivitiesReferences()
    {
        $activities_references = array(
            ...
            0    => __('CGT has been installed', 'cftp_admin'),
            30    => __('CGT was updated', 'cftp_admin'),
            ...
            50    => __('A task was assigned', 'cftp_admin'),
            51    => __('A task status was updated', 'cftp_admin'),
            52    => __('An approval request was created', 'cftp_admin'),
            53    => __('An approval request was processed', 'cftp_admin'),
            54    => __('A support ticket was created', 'cftp_admin'),
            55    => __('A support ticket received a reply', 'cftp_admin'),
            56    => __('A support ticket status was updated', 'cftp_admin'),
        );
