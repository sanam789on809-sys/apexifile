    ...
    private function getEmailTypeData($email_type)
    {
        ...
        switch ($email_type) {
            ...
            case 'new_client':
                ...
                $strings = array(
                    'subject' => (get_option('email_new_client_by_user_subject_customize') == 1 && !empty(get_option('email_new_client_by_user_subject'))) ? get_option('email_new_client_by_user_subject') : __('Welcome to CGT', 'cftp_admin'),
            ...
            case 'new_user':
                ...
                $strings = array(
                    'subject' => (get_option('email_new_user_subject_customize') == 1 && !empty(get_option('email_new_user_subject'))) ? get_option('email_new_user_subject') : __('Welcome to CGT', 'cftp_admin'),
                    ...
                    'body3' => __('Thank you for using CGT.', 'cftp_admin'),
                    'label_user' => __('Your username', 'cftp_admin'),
                    'label_pass' => __('Your password', 'cftp_admin')
                );
                $options = [
