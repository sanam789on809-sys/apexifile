...
function format_action_log_record($params)
{
	...
	switch ($action) {
		case 0:
            $action_text = __('CGT was installed','cftp_admin');
            $formatted = __('CGT was installed','cftp_admin');
            $type = 'system';
			break;
		case 1:
			$part1 = $owner_user;
		...
		case 30:
			$part1 = $owner_user;
			$action_text = __('updated CGT to version','cftp_admin');
            $part2 = (isset($details->version)) ? $details->version : null;
            $formatted = sprintf(__('%s updated CGT to version %s','cftp_admin'), $owner_user, $part2);
            $type = 'system';
			break;
        case 49:
            $part1 = $owner_user;
